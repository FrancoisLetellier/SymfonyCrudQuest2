...
use FrancoisBundle\Entity\flight;
...
class flightController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $flights = $em->getRepository('FrancoisBundle:flight')->findAll();
    ...
    {
        $flight = new Flight();
        $form = $this->createForm('FrancoisBundle\Form\flightType', $flight);
    ...
    {
        $deleteForm = $this->createDeleteForm($flight);
        $editForm = $this->createForm('FrancoisBundle\Form\flightType', $flight);
