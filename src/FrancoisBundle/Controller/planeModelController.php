...
use FrancoisBundle\Entity\planeModel;
...
class planeModelController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $planeModels = $em->getRepository('FrancoisBundle:planeModel')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('FrancoisBundle\Form\planeModelType', $planeModel);
    ...
    {
        $deleteForm = $this->createDeleteForm($planeModel);
        $editForm = $this->createForm('FrancoisBundle\Form\planeModelType', $planeModel);
